...
| :-- | :-- |
| 这个写法会不会原样进入浏览器？ | 编译期 |
| 它最终生成的是 props、事件、slot 还是分支结构？ | 渲染函数 / VNode |
...
这一章真正要完成的，不是“背会 Vue 语法”，而是把这些常见写法重新识别成：

- 编译期展开
- 运行时协议
- 模板到产物的映射关系

一旦这种识别能力建立起来，Vue 的很多“魔法感”会明显下降。

## 下一章建议

如果你已经能把语法糖和产物联系起来，接下来建议进入 [进阶章节](/advanced/)，开始看真实构建结果和 SSR 工程场景。
